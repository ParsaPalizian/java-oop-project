...
public class ForwardGroupMessageToGroupMenuHelper {
    ...
    public static void performForwardToGroupCommand(String command) throws SQLException {
        ...
        switch (command.toUpperCase(Locale.ROOT)) {
            ...
            case "S":
                ...
                message.setForwardedFromId(Globals.currentForwardedGroupMessage.getSender().getId());
                message.setContent(Globals.currentForwardedGroupMessage.getContent());
