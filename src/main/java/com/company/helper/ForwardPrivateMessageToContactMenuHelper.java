...
public class ForwardPrivateMessageToContactMenuHelper {
    ...
    public static void performForwardToContactsCommand(String command) throws SQLException {
        ...
        switch (command.toUpperCase(Locale.ROOT)) {
            ...
            case "S":
                ...
                privateMessage.setForwardedFromId(Globals.currentForwardedPrivateMessage.getSender().getId());
                privateMessage.setContent(Globals.currentForwardedPrivateMessage.getContent());
